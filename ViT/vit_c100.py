...
def main():
    ...
    for i in range(10):
        ...
        state_dict = torch.load('./ViT-CIFAR/weights/vit_c100_aa_ls.pth')
        ...
        test_class_loader = DataLoader(test_class_datasets[class_id], batch_size=98, shuffle=True)
        test_non_class_loader = DataLoader(test_non_class_datasets[class_id], batch_size=492, shuffle=True)
